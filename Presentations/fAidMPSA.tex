...
\frame
{
  \frametitle{Puzzle}
  \begin{itemize}
  \item How do we explain foreign aid dispersements in the wake of natural disasters with the existing literature which finds that aid is given for strategic purposes?
  \end{itemize}    
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Natural disasters can drastically shift the social context of a dyadic relationship toward emphasizing its altruistic or humanitarian dimensions. \\

This shift is greater depending on the severity of the natural disaster and the extent to which the baseline dyadic relationship can be characterized as contentious.
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame
{
  \frametitle{Causal Logic}

  \begin{enumerate}
 \item  Natural disasters shift the social norms of interstate relations
  \pause
  \item  Countries take advantage of natural disasters to strategically ingratiate themselves with strategic opponents
  \end{enumerate}
...
\frame
{
  \frametitle{Measuring Humanitarian Interest}
  \begin{itemize}
...
\frame
{
  \frametitle{Aid Model Results}
    \centering
    \hspace*{-.2in}
  \resizebox{1\textwidth}{!}{\input{Graphics/modCoef.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame
{
  ...
  \centering
  \hspace*{-.2in}
  \resizebox{1.1\textwidth}{!}{\input{Graphics/effects.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame
{
  \frametitle{Temporal Contingencies?}
    \centering
    \hspace*{-.2in}
  \resizebox{1.1\textwidth}{!}{\input{Graphics/timeCross.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame
{
  \frametitle{Donor Country Contingencies?}
    \centering
    \hspace*{-.2in}
  \resizebox{1.1\textwidth}{!}{\input{Graphics/cntryCross.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame
{
  \frametitle{Incorporate Interaction}
    \centering
    \hspace*{-.2in}
  \resizebox{1\textwidth}{!}{\input{Graphics/modCoef2.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame
{
  \frametitle{Interactive Effects}
    \centering
    \hspace*{-.2in}
  \resizebox{1.1\textwidth}{!}{\input{Graphics/intEffect.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
