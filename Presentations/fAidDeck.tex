...
\frame
{
  ...
  \begin{itemize}
  \item  Consensus is that strategic interest takes precedence over humanitarian ones in foreign aid allocation
  \pause
...
\frame
{
  \frametitle{Substantive Effects}
    \centering
  \resizebox{1\textwidth}{!}{\input{Graphics/stratEffect.tex}}
} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
