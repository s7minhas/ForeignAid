...
# getRMSE_kFold_wRE = function(ii, kk,  mod, data){
#   fromfn = predict(object=mod[[ii]], newdata=data[[ii]], allow.new.levels=TRUE, re.form=~(1|id)+(1|year))
#   (fromfn - data[[ii]]$commitUSD13)^2 %>% mean(.) %>% sqrt(.)
# }
getRMSE_wRE = function(m, k, mod, data){
  lapply(1:m, function(mm) {
    impMod = mod[[mm]]
    impData = data[[mm]]
...
# ------ latent variables
getRMSE_wRE(5, 5,`5-Fold_ccodeS_gaussian_re_LstratMu`, xKout_ccodeS )
getRMSE_wRE(5, 5,`5-Fold_ccodeS_gaussian_re_LallyDist`, xKout_ccodeS )
getRMSE_wRE(5, 5,`5-Fold_ccodeS_gaussian_re_LigoDist`, xKout_ccodeS )
getRMSE_wRE(5, 5,`5-Fold_ccodeS_gaussian_re_LunDist`, xKout_ccodeS )
  
getRMSE_wRE(5, 5,allyModsS, xKout_ccodeS )
getRMSE_wRE(5, 5,allyModsR, xKout_ccodeR )
getRMSE_wRE(5, 5,allyModsY, xKout_year )

getRMSE_wRE(5, 5,stratMuModsS, xKout_ccodeS )
getRMSE_wRE(5, 5,stratMuModsR, xKout_ccodeR )
getRMSE_wRE(5, 5,stratMuModsY, xKout_year )
