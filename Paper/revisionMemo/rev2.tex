...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{
		We agree with Reviewer 2 and ideally we would also have liked to extend the analysis past 2005. However, we face the constraint that the IGO data is simmply not available past 2005 which restricts our ability to construct our strategic interest variable and consequently, also restricts our ability to model the relationship between strategic interest and aid. 
		}}
	\end{itemize}	
