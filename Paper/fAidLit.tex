...
Even fairly straightforward humanitarian variables are difficult to interpret - GDP thing. 
...
A further empirical contribution we make in this paper is touse a hierarchical model with random effects address this dependence.



Fifteen years ago, Alesina and Dollar asked 'who gives aid to whom and why,' and a plethora of scholars have sought to advance their own response. While people have been trying to answer this question before Alesina and Dollar and posed it, 
...
Scholars have uncovered a considerable amount of variation in foreign aid giving among donor countries. 
Yet the interpretation of such variation is difficult to assess: a fairly consistent finding is that France is more likely than other donors to give to its former colonies, but should this be interpreted as the French seeking to advance their strategic interests or

Scholars that have sought to model the motivations of foreign aid across all countries have typically done so by throwing all countries together in a pooled model (Berthelemy 2004, Alesina and Dollar). This is problematic because it assumes



3. One reason for this lack of consensus is that i) people just can't agree as to what these variables mean ? ii) the empi 
...
Foreign aid is a very strange and very modern practice. Perhaps this explains the plethora of papers that seek to examine the motivation for foreign aid. 



That is not to say that the motivations for giving foreign aid are mutually exclusive. The tension between 


While existing studies acknowledge this tension, curiously they have not done a good job of taking it into account when making modeling decisions.

Instead of looking at general trends across countries, they have looked at the motivations of individual countries
