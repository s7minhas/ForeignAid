...
\singlespacing{
	...
	Many studies have come out in recent years trying to predict foreign aid flows

	Number of hypotheses have been developed ranging from needs based to alliance formation

	Yet each of these approaches analyzes foreign aid flows in a dyadic context where they assume that the flow of aid between any particular dyad is independent of any other
	...
	we should state some network level hypotheses, like transitivity or preferential attachment
