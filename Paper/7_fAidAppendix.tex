...
\clearpage
\subsection*{Reanalysis when Including Lagged Dependent Variable}
...
When including the lagged dependent variable we see no change in the substantive implications of the model for humanitarian, civil society, or development aid. The results including the lagged dependent variable in the specification are shown in Figure~\ref{fig:simEffects_lagDV} and those without are shown in Figure~\ref{fig:simEffects} of the paper.
...
We also present tabular versions of the fixed effect results below:
...
\begin{tabular}{rrrrlr}
  \hline
Humanitarian Aid & beta & se & t & var & pval \\ 
  \hline
& 0.81 & 0.10 & 8.11 & Pol. \; Strat.  \; Distance_{sr,t-1} & 0.00 \\ 
& -0.12 & 0.07 & -1.74 & No. \; Disasters_{r,t-1} & 0.08 \\ 
& 9.56 & 1.66 & 5.78 & Colony_{sr,t-1} & 0.00 \\ 
& 0.00 & 0.01 & 0.31 & Polity_{r,t-1} & 0.76 \\ 
& -1.08 & 0.08 & -12.80 & Log(GDP \; per \; capita_{r,t-1} & 0.00 \\ 
& -0.03 & 0.01 & -2.30 & Life \;Expect_{r,t-1} & 0.02 \\ 
& 1.41 & 0.11 & 12.99 & Civil \; War_{r,t-1} & 0.00 \\ 
& 0.08 & 0.02 & 4.11 & Pol. \; Strat.  \; Distance_{sr,t-1}:No. \; Disasters_{r,t-1} & 0.00 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{tabular}{rrrrlr}
  \hline
Civil Society Aid & beta & se & t & var & pval \\ 
  \hline
& -0.18 & 0.09 & -2.03 & Pol. \; Strat.  \; Distance_{sr,t-1} & 0.04 \\ 
   & -0.19 & 0.06 & -3.11 & No. \; Disasters_{r,t-1} & 0.00 \\ 
   & 2.00 & 1.44 & 1.39 & Colony_{sr,t-1} & 0.16 \\ 
   & 0.02 & 0.01 & 2.52 & Polity_{r,t-1} & 0.01 \\ 
  & -0.62 & 0.07 & -8.48 & Log(GDP \; per \; capita_{r,t-1} & 0.00 \\ 
  & 0.02 & 0.01 & 2.32 & Life \;Expect_{r,t-1} & 0.02 \\ 
  & -0.34 & 0.09 & -3.66 & Civil \; War_{r,t-1} & 0.00 \\ 
   & 0.10 & 0.02 & 5.83 & Pol. \; Strat.  \; Distance_{sr,t-1}:No. \; Disasters_{r,t-1} & 0.00 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{tabular}{rrrrlr}
  \hline
Development Aid & beta & se & t & var & pval \\ 
  \hline
& -0.76 & 0.10 & -7.45 & Pol. \; Strat.  \; Distance_{sr,t-1} & 0.00 \\ 
   & -0.04 & 0.07 & -0.50 & No. \; Disasters_{r,t-1} & 0.61 \\ 
   & 9.70 & 1.67 & 5.81 & Colony_{sr,t-1} & 0.00 \\ 
   & 0.04 & 0.01 & 4.96 & Polity_{r,t-1} & 0.00 \\ 
   & -0.63 & 0.09 & -7.29 & Log(GDP \; per \; capita_{r,t-1} & 0.00 \\ 
   & 0.10 & 0.01 & 8.63 & Life \;Expect_{r,t-1} & 0.00 \\ 
   & -0.73 & 0.11 & -6.67 & Civil \; War_{r,t-1} & 0.00 \\ 
   & 0.02 & 0.02 & 1.20 & Pol. \; Strat.  \; Distance_{sr,t-1}:No. \; Disasters_{r,t-1} & 0.23 \\ 
   \hline
\end{tabular}
\end{table}
\FloatBarrier
