...
% \label{rmse:donor}
% \includegraphics[width=.8\textwidth]{rmse_10FoldCrossVal_ccodeS.pdf}
% \end{figure}
...
% \includegraphics[width=.8\textwidth]{rmse_10FoldCrossVal_ccodeR.pdf}
% \end{figure}
...
% \label{rmse:year}
% \includegraphics[width=.8\textwidth]{rmse_10FoldCrossVal_year.pdf}
% \end{figure}
% \FloatBarrier
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{noIntCoef.pdf}
