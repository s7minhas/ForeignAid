...
%DIF DEL /Users/cindycheng/Documents/Papers/ForeignAid/Paper/Revision1/Paper/fAid.tex   Sat Aug  3 11:31:30 2019
%DIF ADD /Users/cindycheng/Documents/Papers/ForeignAid/Paper/Revision2/fAid.tex         Sat Aug  3 13:47:46 2019
...
%DIF 163c163
%DIF < \graphicspath{{graphics/}}
%DIF -------
\graphicspath{{/Users/cindycheng/Documents/Papers/ForeignAid/graphics/}{/Users/cindycheng/Documents/Papers/ForeignAid/}} %DIF > 
%DIF -------
\makeatletter
%DIF 165c165
%DIF < \def\input@path{{graphics/}}
%DIF -------
\def\input@path{{/Users/cindycheng/Documents/Papers/ForeignAid/graphics/}{/Users/cindycheng/Documents/Papers/ForeignAid/}} %DIF > 
%DIF -------
 \makeatother
...
\DIFdelbegin %DIFDELCMD < \bibliography{Paper/fAidRefs.bib}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{thebibliography}{}
\DIFaddend 

\DIFaddbegin \bibitem[\protect\citeauthoryear{Alesina and Dollar}{Alesina and
  Dollar}{2000}]{alesina:2000}
\DIFadd{Alesina, A. and D.~Dollar (2000).
}\newblock \DIFadd{Who gives foreign aid to whom and why?
}\newblock {\em \DIFadd{Journal of economic growth\/}}\DIFadd{~}{\em \DIFadd{5\/}}\DIFadd{(1), 33--63.
}

\bibitem[\protect\citeauthoryear{Andrabi and Das}{Andrabi and
  Das}{2017}]{andrabi:2017}
\DIFadd{Andrabi, T. and J.~Das (2017).
}\newblock \DIFadd{In aid we trust: Hearts and minds and the pakistan earthquake of
  2005.
}\newblock {\em \DIFadd{Review of Economics and Statistics\/}}\DIFadd{~}{\em \DIFadd{99\/}}\DIFadd{(3), 371--386.
}

\bibitem[\protect\citeauthoryear{Bank}{Bank}{2013}]{wb:2013}
\DIFadd{Bank, W. (2013).
}\newblock \DIFadd{World development indicators online (wdi) database.
}

\bibitem[\protect\citeauthoryear{Bermeo}{Bermeo}{2018}]{bermeo:2018}
\DIFadd{Bermeo, S. (2018).
}\newblock {\em \DIFadd{Targeted Development: Industrialized Country Strategy in a
  Globalizing World}}\DIFadd{.
}\newblock \DIFadd{Oxford University Press.
}

\bibitem[\protect\citeauthoryear{Bermeo}{Bermeo}{2008}]{bermeo:2008}
\DIFadd{Bermeo, S.~B. (2008).
}\newblock \DIFadd{Aid strategies of bilateral donors.
}\newblock {\em \DIFadd{Unpublished Working Paper\/}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Bermeo}{Bermeo}{2017}]{bermeo:2017}
\DIFadd{Bermeo, S.~B. (2017).
}\newblock \DIFadd{Aid allocation and targeted development in an increasingly connected
  world.
}\newblock {\em \DIFadd{International Organization\/}}\DIFadd{~}{\em \DIFadd{71\/}}\DIFadd{(4), 735--766.
}

\bibitem[\protect\citeauthoryear{Berth{\'e}lemy}{Berth{\'e}lemy}{2006}]{berthelemy:2006}
\DIFadd{Berth}{\DIFadd{\'e}}\DIFadd{lemy, J.-C. (2006).
}\newblock \DIFadd{Bilateral donors? interest vs. recipients? development motives in aid
  allocation: do all donors behave the same?
}\newblock {\em \DIFadd{Review of Development Economics\/}}\DIFadd{~}{\em \DIFadd{10\/}}\DIFadd{(2), 179--194.
}

\bibitem[\protect\citeauthoryear{Berth{\'e}lemy and Tichit}{Berth{\'e}lemy and
  Tichit}{2004}]{berthelemy:2004}
\DIFadd{Berth}{\DIFadd{\'e}}\DIFadd{lemy, J.-C. and A.~Tichit (2004).
}\newblock \DIFadd{Bilateral donors' aid allocation decisions?a three-dimensional panel
  analysis.
}\newblock {\em \DIFadd{International Review of Economics \& Finance\/}}\DIFadd{~}{\em \DIFadd{13\/}}\DIFadd{(3),
  253--274.
}

\bibitem[\protect\citeauthoryear{Bryant, Chiba, Heinrich, and Kobayahsi}{Bryant
  et~al.}{2018}]{bryant_etal:2018}
\DIFadd{Bryant, K., D.~Chiba, T.~Heinrich, and Y.~Kobayahsi (2018).
}\newblock \DIFadd{Colonial history, public opinion, and the allocation of foreign aid.
}\newblock {\em \DIFadd{Working Paper\/}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Bueno~de Mesquita}{Bueno~de
  Mesquita}{1975}]{demesquita:1975}
\DIFadd{Bueno~de Mesquita, B. (1975).
}\newblock \DIFadd{Measuring systemic polarity.
}\newblock {\em \DIFadd{Journal of Conflict Resolution\/}}\DIFadd{~}{\em \DIFadd{19\/}}\DIFadd{(2), 187--216.
}

\bibitem[\protect\citeauthoryear{Bueno~de Mesquita and Smith}{Bueno~de Mesquita
  and Smith}{2016}]{deMesquita:Smith:2016}
\DIFadd{Bueno~de Mesquita, B. and A.~Smith (2016).
}\newblock \DIFadd{Competition and collaboration in aid-for-policy deals.
}\newblock {\em \DIFadd{International Studies Quarterly\/}}\DIFadd{~}{\em \DIFadd{60\/}}\DIFadd{(3), 413--426.
}

\bibitem[\protect\citeauthoryear{Buthe and Cheng}{Buthe and
  Cheng}{2013}]{buthecheng:2013}
\DIFadd{Buthe, T. and C.~Cheng (2013).
}\newblock {\em \DIFadd{Private Transnational Governance of Economic Development:
  International Development Aid}}\DIFadd{, pp.\  322--342.
}\newblock \DIFadd{Routledge.
}

\bibitem[\protect\citeauthoryear{B{\"u}the, Major, and e~Souza}{B{\"u}the
  et~al.}{2012}]{buthe:2012}
\DIFadd{B}{\DIFadd{\"u}}\DIFadd{the, T., S.~Major, and A.~d.~M. e~Souza (2012).
}\newblock \DIFadd{The politics of private foreign aid: humanitarian principles,
  economic development objectives, and organizational interests in ngo private
  aid allocation.
}\newblock {\em \DIFadd{International Organization\/}}\DIFadd{~}{\em \DIFadd{66\/}}\DIFadd{(4), 571--607.
}

\bibitem[\protect\citeauthoryear{Carnegie and Marinov}{Carnegie and
  Marinov}{2017}]{carnegie:2017}
\DIFadd{Carnegie, A. and N.~Marinov (2017).
}\newblock \DIFadd{Foreign aid, human rights, and democracy promotion: evidence from a
  natural experiment.
}\newblock {\em \DIFadd{American Journal of Political Science\/}}\DIFadd{~}{\em \DIFadd{61\/}}\DIFadd{(3),
  671--683.
}

\bibitem[\protect\citeauthoryear{Carter and Stone}{Carter and
  Stone}{2015}]{carter:stone:2015}
\DIFadd{Carter, D.~B. and R.~W. Stone (2015).
}\newblock \DIFadd{Democracy and multilateralism: the case of vote buying in the un
  general assembly.
}\newblock {\em \DIFadd{International Organization\/}}\DIFadd{~}{\em \DIFadd{69\/}}\DIFadd{(1), 1--33.
}

\bibitem[\protect\citeauthoryear{Chen, Gou, Zhang, and Giles}{Chen
  et~al.}{2012}]{chen:2012}
\DIFadd{Chen, H.-H., L.~Gou, X.~L. Zhang, and C.~L. Giles (2012).
}\newblock \DIFadd{Discovering missing links in networks using vertex similarity
  measures.
}\newblock \DIFadd{In }{\em \DIFadd{Proceedings of the 27th annual ACM symposium on applied
  computing}}\DIFadd{, pp.\  138--143. ACM.
}

\bibitem[\protect\citeauthoryear{Clist}{Clist}{2009}]{clist:2009}
\DIFadd{Clist, P. (2009).
}\newblock \DIFadd{25 years of aid allocation practice: comparing donors and eras.
}\newblock \DIFadd{Technical report, CREDIT research paper.
}

\bibitem[\protect\citeauthoryear{Collier and Dollar}{Collier and
  Dollar}{2002}]{collier:2002}
\DIFadd{Collier, P. and D.~Dollar (2002).
}\newblock \DIFadd{Aid allocation and poverty reduction.
}\newblock {\em \DIFadd{European Economic Review\/}}\DIFadd{~}{\em \DIFadd{46\/}}\DIFadd{(8), 1475--1500.
}

\bibitem[\protect\citeauthoryear{David}{David}{2011}]{david:2011}
\DIFadd{David, A.~C. (2011).
}\newblock \DIFadd{How do international financial flows to developing countries respond
  to natural disasters?
}\newblock {\em \DIFadd{Global Economy Journal\/}}\DIFadd{~}{\em \DIFadd{11\/}}\DIFadd{(4).
}

\bibitem[\protect\citeauthoryear{de~Buitrago}{de~Buitrago}{2012}]{de:2012}
\DIFadd{de~Buitrago, S.~R. (2012).
}\newblock {\em \DIFadd{Portraying the Other in International Relations: Cases of
  Othering, Their Dynamics and the Potential for Transformation}}\DIFadd{.
}\newblock \DIFadd{Cambridge Scholars Publishing.
}

\bibitem[\protect\citeauthoryear{De~Mesquita and Smith}{De~Mesquita and
  Smith}{2007}]{demesquita:2007}
\DIFadd{De~Mesquita, B.~B. and A.~Smith (2007).
}\newblock \DIFadd{Foreign aid and policy concessions.
}\newblock {\em \DIFadd{Journal of Conflict Resolution\/}}\DIFadd{~}{\em \DIFadd{51\/}}\DIFadd{(2), 251--284.
}

\bibitem[\protect\citeauthoryear{De~Mesquita and Smith}{De~Mesquita and
  Smith}{2009}]{deMesquita:Smith:2009}
\DIFadd{De~Mesquita, B.~B. and A.~Smith (2009).
}\newblock \DIFadd{A political economy of aid.
}\newblock {\em \DIFadd{International Organization\/}}\DIFadd{~}{\em \DIFadd{63\/}}\DIFadd{(2), 309--340.
}

\bibitem[\protect\citeauthoryear{Dietrich}{Dietrich}{2013}]{dietrich:2013}
\DIFadd{Dietrich, S. (2013).
}\newblock \DIFadd{Bypass or engage? explaining donor delivery tactics in foreign aid
  allocation.
}\newblock {\em \DIFadd{International Studies Quarterly\/}}\DIFadd{~}{\em \DIFadd{57\/}}\DIFadd{(4), 698--712.
}

\bibitem[\protect\citeauthoryear{Dietrich}{Dietrich}{2016}]{dietrich:2016}
\DIFadd{Dietrich, S. (2016).
}\newblock \DIFadd{Donor political economies and the pursuit of aid effectiveness.
}\newblock {\em \DIFadd{International Organization\/}}\DIFadd{~}{\em \DIFadd{70\/}}\DIFadd{(1), 65--102.
}

\bibitem[\protect\citeauthoryear{Do}{Do}{2011}]{do:2011}
\DIFadd{Do, W. B. E. T.~T. (2011).
}\newblock {\em \DIFadd{Behavioral economics: Past, present, future}}\DIFadd{.
}\newblock \DIFadd{Princeton University Press.
}

\bibitem[\protect\citeauthoryear{Dollar and Levin}{Dollar and
  Levin}{2006}]{dollar:2006}
\DIFadd{Dollar, D. and V.~Levin (2006).
}\newblock \DIFadd{The increasing selectivity of foreign aid, 1984-2003.
}\newblock {\em \DIFadd{World Development\/}}\DIFadd{~}{\em \DIFadd{34\/}}\DIFadd{(12), 2034--2046.
}

\bibitem[\protect\citeauthoryear{Dreher and Fuchs}{Dreher and
  Fuchs}{2015}]{dreher:fuchs:2015}
\DIFadd{Dreher, A. and A.~Fuchs (2015).
}\newblock \DIFadd{Rogue aid? }{\DIFadd{A}}\DIFadd{n empirical analysis of }{\DIFadd{C}}\DIFadd{hina's aid allocation.
}\newblock {\em \DIFadd{Canadian Journal of Economics\/}}\DIFadd{~}{\em \DIFadd{48\/}}\DIFadd{(3), 988--1023.
}

\bibitem[\protect\citeauthoryear{Dreher, Fuchs, Parks, Strange, and
  Tierney}{Dreher et~al.}{2018}]{dreher:2018}
\DIFadd{Dreher, A., A.~Fuchs, B.~Parks, A.~M. Strange, and M.~J. Tierney (2018).
}\newblock \DIFadd{Apples and dragon fruits: }{\DIFadd{T}}\DIFadd{he determinants of aid and other forms
  of state financing from }{\DIFadd{C}}\DIFadd{hina to }{\DIFadd{A}}\DIFadd{frica.
}\newblock {\em \DIFadd{International Studies Quarterly\/}}\DIFadd{~}{\em \DIFadd{62\/}}\DIFadd{(1), 182--194.
}

\bibitem[\protect\citeauthoryear{Dreher, Nunnenkamp, and Schmaljohann}{Dreher
  et~al.}{2015}]{dreher:2015}
\DIFadd{Dreher, A., P.~Nunnenkamp, and M.~Schmaljohann (2015).
}\newblock \DIFadd{The allocation of german aid: Self-interest and government ideology.
}\newblock {\em \DIFadd{Economics \& Politics\/}}\DIFadd{~}{\em \DIFadd{27\/}}\DIFadd{(1), 160--184.
}

\bibitem[\protect\citeauthoryear{Dreher, Nunnenkamp, and Thiele}{Dreher
  et~al.}{2011}]{dreher_etal:2011}
\DIFadd{Dreher, A., P.~Nunnenkamp, and R.~Thiele (2011).
}\newblock \DIFadd{Are `new' donors different? comparing the allocation of bilateral aid
  between non-dac and dac donor countries.
}\newblock {\em \DIFadd{World Development\/}}\DIFadd{~}{\em \DIFadd{39\/}}\DIFadd{(11), 1950--1968.
}

\bibitem[\protect\citeauthoryear{Eisensee and Str{\"o}mberg}{Eisensee and
  Str{\"o}mberg}{2007}]{eisensee:2007}
\DIFadd{Eisensee, T. and D.~Str}{\DIFadd{\"o}}\DIFadd{mberg (2007).
}\newblock \DIFadd{News droughts, news floods, and us disaster relief.
}\newblock {\em \DIFadd{The Quarterly Journal of Economics\/}}\DIFadd{~}{\em \DIFadd{122\/}}\DIFadd{(2), 693--728.
}

\bibitem[\protect\citeauthoryear{Fleck and Kilby}{Fleck and
  Kilby}{2010}]{fleck:kilby:2010}
\DIFadd{Fleck, R.~K. and C.~Kilby (2010).
}\newblock \DIFadd{Changing aid regimes? us foreign aid from the cold war to the war on
  terror.
}\newblock {\em \DIFadd{Journal of Development Economics\/}}\DIFadd{~}{\em \DIFadd{91\/}}\DIFadd{(2), 185--197.
}

\bibitem[\protect\citeauthoryear{Fuchs and Vadlamannati}{Fuchs and
  Vadlamannati}{2013}]{fuchs:Vadlamannati:2013}
\DIFadd{Fuchs, A. and K.~C. Vadlamannati (2013).
}\newblock \DIFadd{The needy donor: An empirical analysis of india’s aid motives.
}\newblock {\em \DIFadd{World Development\/}}\DIFadd{~}{\em \DIFadd{44}}\DIFadd{, 110--128.
}

\bibitem[\protect\citeauthoryear{Gibler}{Gibler}{2009}]{gibler:2009}
\DIFadd{Gibler, D.~M. (2009).
}\newblock {\em \DIFadd{International military alliances, 1648-2008}}\DIFadd{.
}\newblock \DIFadd{CQ Press.
}

\bibitem[\protect\citeauthoryear{Gitay, Bettencourt, Kull, Reid, McCall,
  Simpson, Krausing, Ambrosi, Arnold, Arsovski, et~al.}{Gitay
  et~al.}{2013}]{gitay:2013}
\DIFadd{Gitay, H., S.~Bettencourt, D.~Kull, R.~Reid, K.~McCall, A.~Simpson,
  J.~Krausing, P.~Ambrosi, M.~Arnold, T.~Arsovski, et~al. (2013).
}\newblock \DIFadd{Building resilience: Integrating climate and disaster risk into
  development-lessons from world bank group experience.
}

\bibitem[\protect\citeauthoryear{Gleditsch, Wallensteen, Eriksson, Sollenberg,
  and Strand}{Gleditsch et~al.}{2002}]{gleditsch:2002}
\DIFadd{Gleditsch, N.~P., P.~Wallensteen, M.~Eriksson, M.~Sollenberg, and H.~Strand
  (2002).
}\newblock \DIFadd{Armed conflict 1946-2001: A new dataset.
}\newblock {\em \DIFadd{Journal of peace research\/}}\DIFadd{~}{\em \DIFadd{39\/}}\DIFadd{(5), 615--637.
}

\bibitem[\protect\citeauthoryear{Greene}{Greene}{2008}]{greene:2008}
\DIFadd{Greene, W.~H. (2008).
}\newblock \DIFadd{The econometric approach to efficiency analysis.
}\newblock {\em \DIFadd{The measurement of productive efficiency and productivity
  growth\/}}\DIFadd{~}{\em \DIFadd{1\/}}\DIFadd{(1), 92--250.
}

\bibitem[\protect\citeauthoryear{Guha-Sapir, Below, and Hoyois}{Guha-Sapir
  et~al.}{2009}]{emdat:2009}
\DIFadd{Guha-Sapir, D., R.~Below, and P.~Hoyois (2009).
}\newblock \DIFadd{Em-dat: International disaster database.
}\newblock {\em \DIFadd{Universite Catholique de Louvain, Brussels, Belgium\/}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Gurr, Marshall, and Jaggers}{Gurr
  et~al.}{2010}]{gurr:2010}
\DIFadd{Gurr, T., M.~Marshall, and K.~Jaggers (2010).
}\newblock \DIFadd{Polity iv project: Political regime characteristics and transitions,
  1800-2009.
}

\bibitem[\protect\citeauthoryear{Harmer, Cotterrell, and Institute}{Harmer
  et~al.}{2005}]{harmer:2005}
\DIFadd{Harmer, A., L.~Cotterrell, and L.~O.~D. Institute (2005).
}\newblock {\em \DIFadd{Diversity in donorship: The changing landscape of official
  humanitarian aid}}\DIFadd{.
}\newblock \DIFadd{Humanitarian Policy Group, Overseas Development Institute.
}

\bibitem[\protect\citeauthoryear{Hartberg, Proust, and Bailey}{Hartberg
  et~al.}{2011}]{hartberg:2011}
\DIFadd{Hartberg, M., A.~Proust, and M.~Bailey (2011).
}\newblock {\em \DIFadd{From Relief to Recovery: Supporting good governance in
  post-earthquake Haiti}}\DIFadd{, Volume 142.
}\newblock \DIFadd{Oxfam.
}

\bibitem[\protect\citeauthoryear{Henderson}{Henderson}{2002}]{henderson:2002}
\DIFadd{Henderson, S.~L. (2002).
}\newblock \DIFadd{Selling civil society: Western aid and the nongovernmental
  organization sector in russia.
}\newblock {\em \DIFadd{Comparative political studies\/}}\DIFadd{~}{\em \DIFadd{35\/}}\DIFadd{(2), 139--167.
}

\bibitem[\protect\citeauthoryear{Hensel}{Hensel}{2009}]{hensel:2009}
\DIFadd{Hensel, P.~R. (2009).
}\newblock \DIFadd{Icow colonial history data set, version 1.0.
}\newblock {\em \DIFadd{University of North Texas. http://www. paulhensel. org/icowcol.
  html\/}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Heradstveit and Bonham}{Heradstveit and
  Bonham}{2007}]{heradstveit:2007}
\DIFadd{Heradstveit, D. and M.~G. Bonham (2007).
}\newblock \DIFadd{What the axis of evil metaphor did to iran.
}\newblock {\em \DIFadd{The Middle East Journal\/}}\DIFadd{~}{\em \DIFadd{61\/}}\DIFadd{(3), 421--440.
}

\bibitem[\protect\citeauthoryear{Hoeffler and Outram}{Hoeffler and
  Outram}{2011}]{hoeffler:2011}
\DIFadd{Hoeffler, A. and V.~Outram (2011).
}\newblock \DIFadd{Need, merit, or self-interest?what determines the allocation of aid?
}\newblock {\em \DIFadd{Review of Development Economics\/}}\DIFadd{~}{\em \DIFadd{15\/}}\DIFadd{(2), 237--250.
}

\bibitem[\protect\citeauthoryear{Hoff}{Hoff}{2005}]{hoff:2005}
\DIFadd{Hoff, P.~D. (2005).
}\newblock \DIFadd{Bilinear mixed-effects models for dyadic data.
}\newblock {\em \DIFadd{Journal of the american Statistical association\/}}\DIFadd{~}{\em
  \DIFadd{100\/}}\DIFadd{(469), 286--295.
}

\bibitem[\protect\citeauthoryear{Hoff}{Hoff}{2007}]{hoff:2007}
\DIFadd{Hoff, P.~D. (2007).
}\newblock \DIFadd{Extending the rank likelihood for semiparametric copula estimation.
}\newblock {\em \DIFadd{The Annals of Applied Statistics\/}}\DIFadd{~}{\em \DIFadd{1\/}}\DIFadd{(1), 265--283.
}

\bibitem[\protect\citeauthoryear{Hollenbach, Metternich, Minhas, and
  Ward}{Hollenbach et~al.}{2014}]{hollenbach:2014}
\DIFadd{Hollenbach, F., N.~W. Metternich, S.~Minhas, and M.~D. Ward (2014).
}\newblock \DIFadd{Fast \& easy imputation of missing social science data.
}\newblock {\em \DIFadd{arXiv preprint arXiv:1411.0647\/}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Kahneman}{Kahneman}{2003}]{kahneman:2003}
\DIFadd{Kahneman, D. (2003).
}\newblock \DIFadd{Maps of bounded rationality: Psychology for behavioral economics.
}\newblock {\em \DIFadd{The American economic review\/}}\DIFadd{~}{\em \DIFadd{93\/}}\DIFadd{(5), 1449--1475.
}

\bibitem[\protect\citeauthoryear{Katzman}{Katzman}{2014}]{katzman:2018}
\DIFadd{Katzman, K. (2014).
}\newblock \DIFadd{Iran sanctions.
}\newblock {\em \DIFadd{Current Politics and Economics of the Middle East\/}}\DIFadd{~}{\em
  \DIFadd{5\/}}\DIFadd{(1), 41.
}

\bibitem[\protect\citeauthoryear{Kral, Tzvetkovska, Damianova, Rihackova,
  Andrespok, Kuusik-Rajasaar, Selmeczi, Akule, Kazmierkiewicz, Soci,
  et~al.}{Kral et~al.}{2013}]{kral:2013}
\DIFadd{Kral, D., M.~Tzvetkovska, A.~Damianova, V.~Rihackova, E.~Andrespok,
  R.~Kuusik-Rajasaar, A.~Selmeczi, D.~Akule, P.~Kazmierkiewicz, A.~Soci, et~al.
  (2013).
}\newblock \DIFadd{The role of civil society in development assistance and aid
  effectiveness.
}

\bibitem[\protect\citeauthoryear{Lancaster}{Lancaster}{2008}]{lancaster:2008}
\DIFadd{Lancaster, C. (2008).
}\newblock {\em \DIFadd{Foreign aid: Diplomacy, development, domestic politics}}\DIFadd{.
}\newblock \DIFadd{University of Chicago Press.
}

\bibitem[\protect\citeauthoryear{Leeds and Savun}{Leeds and
  Savun}{2007}]{leeds:2007}
\DIFadd{Leeds, B.~A. and B.~Savun (2007).
}\newblock \DIFadd{Terminating alliances: Why do states abrogate agreements?
}\newblock {\em \DIFadd{Journal of Politics\/}}\DIFadd{~}{\em \DIFadd{69\/}}\DIFadd{(4), 1118--1132.
}

\bibitem[\protect\citeauthoryear{Liska}{Liska}{1960}]{liska:1960}
\DIFadd{Liska, G. (1960).
}\newblock {\em \DIFadd{The new statecraft: foreign aid in American foreign policy}}\DIFadd{.
}\newblock \DIFadd{Chicago U. of Chicago P.
}

\bibitem[\protect\citeauthoryear{Maizels and Nissanke}{Maizels and
  Nissanke}{1984}]{maizels:1984}
\DIFadd{Maizels, A. and M.~K. Nissanke (1984).
}\newblock \DIFadd{Motivations for aid to developing countries.
}\newblock {\em \DIFadd{World Development\/}}\DIFadd{~}{\em \DIFadd{12\/}}\DIFadd{(9), 879--900.
}

\bibitem[\protect\citeauthoryear{McKinlay and Little}{McKinlay and
  Little}{1977}]{mckinlay:1977}
\DIFadd{McKinlay, R.~D. and R.~Little (1977).
}\newblock \DIFadd{A foreign policy model of us bilateral aid allocation.
}\newblock {\em \DIFadd{World Politics\/}}\DIFadd{~}{\em \DIFadd{30\/}}\DIFadd{(01), 58--86.
}

\bibitem[\protect\citeauthoryear{McKinlay and Little}{McKinlay and
  Little}{1978}]{mckinlay:1978}
\DIFadd{McKinlay, R.~D. and R.~Little (1978).
}\newblock \DIFadd{A foreign-policy model of the distribution of british bilateral aid,
  1960--70.
}\newblock {\em \DIFadd{British Journal of Political Science\/}}\DIFadd{~}{\em \DIFadd{8\/}}\DIFadd{(03), 313--331.
}

\bibitem[\protect\citeauthoryear{McKinlay and Little}{McKinlay and
  Little}{1979}]{mckinley:1979}
\DIFadd{McKinlay, R.~D. and R.~Little (1979).
}\newblock \DIFadd{The us aid relationship: A test of the recipient need and the donor
  interest models.
}\newblock {\em \DIFadd{Political Studies\/}}\DIFadd{~}{\em \DIFadd{27\/}}\DIFadd{(2), 236--250.
}

\bibitem[\protect\citeauthoryear{Milner and Tingley}{Milner and
  Tingley}{2013}]{milner:2013}
\DIFadd{Milner, H.~V. and D.~Tingley (2013).
}\newblock \DIFadd{The choice for multilateralism: Foreign aid and american foreign
  policy.
}\newblock {\em \DIFadd{The Review of International Organizations\/}}\DIFadd{~}{\em \DIFadd{8\/}}\DIFadd{(3),
  313--341.
}

\bibitem[\protect\citeauthoryear{Montazeri, Baradaran, Omidvari, Azin, Ebadi,
  Garmaroudi, Harirchi, and Shariati}{Montazeri et~al.}{2005}]{montazeri:2005}
\DIFadd{Montazeri, A., H.~Baradaran, S.~Omidvari, S.~A. Azin, M.~Ebadi, G.~Garmaroudi,
  A.~M. Harirchi, and M.~Shariati (2005).
}\newblock \DIFadd{Psychological distress among bam earthquake survivors in iran: a
  population-based study.
}\newblock {\em \DIFadd{BMC public health\/}}\DIFadd{~}{\em \DIFadd{5\/}}\DIFadd{(1), 4.
}

\bibitem[\protect\citeauthoryear{Natsios}{Natsios}{1999}]{natsios:1999}
\DIFadd{Natsios, A. (1999).
}\newblock \DIFadd{The politics of famine in north korea.
}\newblock {\em \DIFadd{United States Institute of Peace (USIP)\/}}\DIFadd{~}{\em \DIFadd{Special Volume}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Neumayer}{Neumayer}{2003}]{neumayer:2003}
\DIFadd{Neumayer, E. (2003).
}\newblock \DIFadd{What factors determine the allocation of aid by arab countries and
  multilateral agencies?
}\newblock {\em \DIFadd{Journal of Development Studies\/}}\DIFadd{~}{\em \DIFadd{39\/}}\DIFadd{(4), 134--147.
}

\bibitem[\protect\citeauthoryear{Neumayer}{Neumayer}{2005}]{neumayer:2005}
\DIFadd{Neumayer, E. (2005).
}\newblock {\em \DIFadd{The pattern of aid giving: the impact of good governance on
  development assistance}}\DIFadd{.
}\newblock \DIFadd{Routledge.
}

\bibitem[\protect\citeauthoryear{Noland}{Noland}{2004}]{noland:2004}
\DIFadd{Noland, M. (2004).
}\newblock \DIFadd{Famine and reform in north korea.
}\newblock {\em \DIFadd{Asian Economic Papers\/}}\DIFadd{~}{\em \DIFadd{3\/}}\DIFadd{(2), 1--40.
}

\bibitem[\protect\citeauthoryear{Nunnenkamp and {\"O}hler}{Nunnenkamp and
  {\"O}hler}{2011}]{nunnenkamp:2011}
\DIFadd{Nunnenkamp, P. and H.~}{\DIFadd{\"O}}\DIFadd{hler (2011).
}\newblock \DIFadd{Aid allocation through various official and private channels: Need,
  merit, and self-interest as motives of german donors.
}\newblock {\em \DIFadd{World Development\/}}\DIFadd{~}{\em \DIFadd{39\/}}\DIFadd{(3), 308--323.
}

\bibitem[\protect\citeauthoryear{Nunnenkamp and Thiele}{Nunnenkamp and
  Thiele}{2006}]{nunnenkamp:2006}
\DIFadd{Nunnenkamp, P. and R.~Thiele (2006).
}\newblock \DIFadd{Targeting aid to the needy and deserving: nothing but promises?
}\newblock {\em \DIFadd{The World Economy\/}}\DIFadd{~}{\em \DIFadd{29\/}}\DIFadd{(9), 1177--1201.
}

\bibitem[\protect\citeauthoryear{Olsen, Carstensen, and H{\o}yen}{Olsen
  et~al.}{2003}]{olsen:2003}
\DIFadd{Olsen, G.~R., N.~Carstensen, and K.~H}{\DIFadd{\o}}\DIFadd{yen (2003).
}\newblock \DIFadd{Humanitarian crises: what determines the level of emergency
  assistance? media coverage, donor interests and the aid business.
}\newblock {\em \DIFadd{Disasters\/}}\DIFadd{~}{\em \DIFadd{27\/}}\DIFadd{(2), 109--126.
}

\bibitem[\protect\citeauthoryear{Ottaway and Carothers}{Ottaway and
  Carothers}{2000}]{ottaway:2000}
\DIFadd{Ottaway, M. and T.~Carothers (2000).
}\newblock {\em \DIFadd{Funding virtue: civil society aid and democracy promotion}}\DIFadd{.
}\newblock \DIFadd{Carnegie Endowment.
}

\bibitem[\protect\citeauthoryear{Pevehouse, Nordstrom, and Warnke}{Pevehouse
  et~al.}{2010}]{pevehouse:2004}
\DIFadd{Pevehouse, J., T.~Nordstrom, and K.~Warnke (2010).
}\newblock \DIFadd{The correlates of war 2 international governmental organizations data
  version 2.3.
}\newblock \DIFadd{~(2).
}

\bibitem[\protect\citeauthoryear{Qian}{Qian}{2015}]{qian:2015}
\DIFadd{Qian, N. (2015).
}\newblock \DIFadd{Making progress on foreign aid.
}\newblock {\em \DIFadd{Annu. Rev. Econ.\/}}\DIFadd{~}{\em \DIFadd{7\/}}\DIFadd{(1), 277--308.
}

\bibitem[\protect\citeauthoryear{Resnick}{Resnick}{2012}]{resnick2012foreign}
\DIFadd{Resnick, D. (2012).
}\newblock \DIFadd{Foreign aid in africa-tracing channels of influence on democratic
  transitions and consolidation.
}\newblock {\em \DIFadd{World Institute for Development Economics Research (WIDER),
  WIDER Working Paper\/}}\DIFadd{~}{\em \DIFadd{15}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Robinson}{Robinson}{1995}]{robinson:1995}
\DIFadd{Robinson, M. (1995).
}\newblock \DIFadd{Strengthening civil society in africa: The role of foreign political
  aid.
}\newblock {\em \DIFadd{IDS bulletin\/}}\DIFadd{~}{\em \DIFadd{26\/}}\DIFadd{(2), 70--80.
}

\bibitem[\protect\citeauthoryear{Rubin}{Rubin}{1987}]{rubin:1987}
\DIFadd{Rubin, D.~B. (1987).
}\newblock \DIFadd{The calculation of posterior distributions by data augmentation:
  ...
  \DIFadd{82\/}}\DIFadd{(398), 543--546.
}

\bibitem[\protect\citeauthoryear{Samore}{Samore}{2015}]{samore:2015}
\DIFadd{Samore, G. (2015).
}\newblock \DIFadd{Sanctions against iran: A guide to targets, terms, and timetables.
}\newblock {\em \DIFadd{Belfer Center for Science and International Affairs\/}}\DIFadd{, 28--29.
}

\bibitem[\protect\citeauthoryear{Schraeder, Hook, and Taylor}{Schraeder
  et~al.}{1998}]{schraeder.etal:1998}
\DIFadd{Schraeder, P.~J., S.~W. Hook, and B.~Taylor (1998).
}\newblock \DIFadd{Clarifying the foreign aid puzzle.
}\newblock {\em \DIFadd{World Politics\/}}\DIFadd{~}{\em \DIFadd{50\/}}\DIFadd{(2), 294--323.
}

\bibitem[\protect\citeauthoryear{Signorino and Ritter}{Signorino and
  Ritter}{1999}]{signorino:1999}
\DIFadd{Signorino, C.~S. and J.~M. Ritter (1999).
}\newblock \DIFadd{Tau-b or not tau-b: Measuring the similarity of foreign policy
  positions.
}\newblock {\em \DIFadd{International Studies Quarterly\/}}\DIFadd{~}{\em \DIFadd{43\/}}\DIFadd{(1), 115--144.
}

\bibitem[\protect\citeauthoryear{Spina and Raymond}{Spina and
  Raymond}{2014}]{spina:2014}
\DIFadd{Spina, N. and C.~Raymond (2014).
}\newblock \DIFadd{Civil society aid to post-communist countries.
}\newblock {\em \DIFadd{Political Studies\/}}\DIFadd{~}{\em \DIFadd{62\/}}\DIFadd{(4), 878--894.
}

\bibitem[\protect\citeauthoryear{Stone}{Stone}{2006}]{stone:2006}
\DIFadd{Stone, R.~W. (2006).
}\newblock \DIFadd{Buying influence: The political economy of international aid.
}\newblock \DIFadd{In }{\em \DIFadd{Annual meeting of the Interanational Studies Association, San
  Diego, CA}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Strezhnev and Voeten}{Strezhnev and
  Voeten}{2012}]{strezhnev:2012}
\DIFadd{Strezhnev, A. and E.~Voeten (2012).
}\newblock \DIFadd{United nations general assembly voting data.
}\newblock {\em \DIFadd{URL: http://hdl. handle. net/1902.1/12379\/}}\DIFadd{.
}

\bibitem[\protect\citeauthoryear{Str{\"o}mberg}{Str{\"o}mberg}{2007}]{stromberg:2007}
\DIFadd{Str}{\DIFadd{\"o}}\DIFadd{mberg, D. (2007).
}\newblock \DIFadd{Natural disasters, economic development, and humanitarian aid.
}\newblock {\em \DIFadd{The Journal of Economic Perspectives\/}}\DIFadd{~}{\em \DIFadd{21\/}}\DIFadd{(3), 199--222.
}

\bibitem[\protect\citeauthoryear{Thiele, Nunnenkamp, and Dreher}{Thiele
  et~al.}{2007}]{thiele:2007}
\DIFadd{Thiele, R., P.~Nunnenkamp, and A.~Dreher (2007).
}\newblock \DIFadd{Do donors target aid in line with the millennium development goals? a
  sector perspective of aid allocation.
}\newblock {\em \DIFadd{Review of World Economics\/}}\DIFadd{~}{\em \DIFadd{143\/}}\DIFadd{(4), 596--630.
}

\bibitem[\protect\citeauthoryear{Tierney, Nielson, Hawkins, Roberts, Findley,
  Powers, Parks, Wilson, and Hicks}{Tierney et~al.}{2011}]{tierney2011more}
\DIFadd{Tierney, M.~J., D.~L. Nielson, D.~G. Hawkins, J.~T. Roberts, M.~G. Findley,
  R.~M. Powers, B.~Parks, S.~E. Wilson, and R.~L. Hicks (2011).
}\newblock \DIFadd{More dollars than sense: refining our knowledge of development
  finance using aiddata.
}\newblock {\em \DIFadd{World Development\/}}\DIFadd{~}{\em \DIFadd{39\/}}\DIFadd{(11), 1891--1906.
}

\bibitem[\protect\citeauthoryear{Trumbull and Wall}{Trumbull and
  Wall}{1994}]{trumbull:1994}
\DIFadd{Trumbull, W.~N. and H.~J. Wall (1994).
}\newblock \DIFadd{Estimating aid-allocation criteria with panel data.
}\newblock {\em \DIFadd{The Economic Journal\/}}\DIFadd{~}{\em \DIFadd{104\/}}\DIFadd{(4), 876--882.
}

\bibitem[\protect\citeauthoryear{Ward and Hoff}{Ward and
  Hoff}{2008}]{hoff_ward:2008}
\DIFadd{Ward, M.~D. and P.~D. Hoff (2008).
}\newblock \DIFadd{Analyzing dependencies in geo-economics and geo-politics.
}\newblock \DIFadd{In }{\em \DIFadd{War, Peace and Security}}\DIFadd{, pp.\  133--160. Emerald Group
  Publishing Limited.
}

\bibitem[\protect\citeauthoryear{Weder and Alesina}{Weder and
  Alesina}{2002}]{alesina:2002}
\DIFadd{Weder, B. and A.~Alesina (2002).
}\newblock \DIFadd{Do corrupt governments receive less foreign aid?
}\newblock {\em \DIFadd{American Economic Association\/}}\DIFadd{~}{\em \DIFadd{92\/}}\DIFadd{(4), 1126--1137.
}

\bibitem[\protect\citeauthoryear{Wieczorek, Larsen, Eaton, Morgan, and
  Blair}{Wieczorek et~al.}{2001}]{wieczorek:2001}
\DIFadd{Wieczorek, G., M.~Larsen, L.~Eaton, B.~Morgan, and J.~Blair (2001).
}\newblock \DIFadd{Debris-flow and flooding hazards associated with the december 1999
  storm in coastal venezuela and strategies for mitigation.
}\newblock \DIFadd{Technical report, United States Geological Survey.
}

\bibitem[\protect\citeauthoryear{Yang}{Yang}{2008}]{yang:2008}
\DIFadd{Yang, D. (2008).
}\newblock \DIFadd{Coping with disaster: The impact of hurricanes on international
  financial flows, 1970-2002.
}\newblock {\em \DIFadd{The BE Journal of Economic Analysis \& Policy\/}}\DIFadd{~}{\em \DIFadd{8\/}}\DIFadd{(1).
}
